 ...
 * @author cent91
 */
public class add_receving extends javax.swing.JFrame {
    ...
    void trans_id_otomatis(){
        ...
        try{
             String sql = "select right(notrans,3) from trans_in";
             ...
             if(rs.next()){
                ...
                while(prod_id.length() < 3){
                    prod_id = "0" +prod_id;
                    txnotrx.setText("INV/IN/"+tggal+prod_id);
                }
                 
             }
             else{
                 txnotrx.setText("INV/IN/"+tggal+"001");
             }
        }
    ...
    void get_customer_data(){
         try{
            ...
            cbcst.addItem("--Supplier--");
            while(result.next()){
                cbcst.addItem(result.getString("supp_id"));
    ...
    void clear_table(){
        try{
            String sql = "truncate temp_trans_in";
    ...
    void tampil_temp_table(){
        int no = 1;
        try{
            String sql = "select temp_trans_in.*,product.name_product from temp_trans_in inner join product on temp_trans_in.product_id = product.product_id";
            ResultSet rs = st.executeQuery(sql);
    ...
    void add_temp(){
        ...
        try{
            String sql = "select * from temp_trans_in where product_id='"+prod_id+"'";
            ResultSet rs = st.executeQuery(sql);
            ...
            if(rs.next()){
               ...
               String sql1 = "update temp_trans_in set qty='"+qty_akhir+"',total='"+sub_akhir+"' where product_id='"+prod_id+"'";
               st.executeUpdate(sql1);
            }
            else{
                String sql2 = "insert into temp_trans_in(notrans,product_id,qty,price,total) values('"+notrans+"','"+prod_id+"','"+qty+"','"+price+"','"+total+"')";
    ...
    void save(){
        String notrans = txnotrx.getText();
        String supp_id = (String) cbcst.getSelectedItem();
        String date = txdate.getText();
        String username = txuser.getText();
        String total = txtotal.getText();
        try{
            String sql = "insert into trans_in values('"+notrans+"','"+date+"','"+supp_id+"','"+username+"','"+total+"')";
            st.executeUpdate(sql);
            
            String sql1 = "select * from temp_trans_in where notrans='"+notrans+"'";
            ...
            while(rs.next()){
                ...
                String sql2 = "insert into trans_in_detail values('"+notrans+"','"+prod_id+"','"+qty+"','"+price+"','"+total1+"')";
            ...
            String sql4 = "delete from temp_trans_in where notrans='"+notrans+"'";
    ...
    private void initComponents() {
        ...
        Header.setText("ADD TRANSACTION (IN)");
        ...
        txnotrx.setText("INV/IN/0012020");
        jPanel1.add(txnotrx, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 100, 130, -1));
        ...
        jPanel1.add(btnadd, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 240, 80, 30));
        ...
        jPanel1.add(btndelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 240, 90, 30));
        ...
        jPanel1.add(btnsave, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 440, 130, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/stock_barang/images/btn-trx-save.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 430, 260, 50));
    ...
    private void cbcstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbcstActionPerformed
        ...
        try{
            String sql = "select * from supplier where supp_id='"+kode+"'";
            ResultSet rs = st.executeQuery(sql);
            if(rs.next()){
                txemail.setText(rs.getString("supp_name"));
                txnophone.setText(rs.getString("supp_nohp"));
            }
        }catch(SQLException e){
            System.out.println("Koneksi Gagal " + e.toString());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(add_receving.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new add_receving().setVisible(true);
            }
        });
    }
